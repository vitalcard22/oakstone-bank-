...
// Keep only the last 4 digits of a sensitive number (data minimization).
...
// New applicants with a full KYC submission stay 'pending' so they appear in the
// admin KYC queue (which reads kyc_status='pending'). Only last-4 of SSN/ID is stored.
