    ...
    <div style={{ fontFamily: "'EB Garamond', Georgia, serif", background: "#fff", color: "#33322C", minHeight: "100vh" }}>
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "64px 32px" }}>
        ...
        <div style={{ fontSize: 17, lineHeight: 1.7 }}>
          ...
          <p>You are responsible for all activity that occurs under your account. Notify us immediately of any unauthorized use or security breach.</p>
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", color: "#1F6B4A", fontSize: 26, marginTop: 28 }}>Limitation of Liability</h2>
          <p>Services are provided in accordance with applicable banking regulations. Our liability is limited to the extent permitted by law.</p>
          <h2 style={{ fontFamily: "'Cormorant Garamond', serif", color: "#1F6B4A", fontSize: 26, marginTop: 28 }}>Changes to Terms</h2>
