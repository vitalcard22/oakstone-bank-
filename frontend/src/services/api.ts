...
export const authApi = {
  ...
  submitKyc: (data: any) => api.post('/auth/kyc', data),
...
export const txApi = {
  ...
  achConfirm: (data: any) => api.post('/transactions/ach/confirm', data),
  zelleConfirm: (data: any) => api.post('/transactions/zelle/confirm', data),
